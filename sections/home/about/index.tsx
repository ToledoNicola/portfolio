  ...
  return (
    <section className={style.section} id="about">
      ...
      <div className={style.title}>
        <h1>Chi sono</h1>
        <h2 className={style.subtitle}>Se ti stai <span>chiedendo</span> chi sono ...</h2>
      </div>
      <div className={style.body}>
        ...
        <p>
          2 mesi dopo il diploma in <em>&quot;Informatica&quot;</em>, ho iniziato a
          lavorare come sviluppatore back-end con php e mysql, pero dopo 2 anni
          non sentivo più gli stessi stimoli che avevo all&apos;inizio, volevo
          provare e sperimentare 🧪 altri campi, conoscere nuove tecnologie e
          girare il 🌎 con il mio 💻
        </p>
        <p>
          cosi decisi di lasciare quel lavoro ed iniziai un Master in
          <span className="ev">Web and Mobile Development</span>, per
          <em>due mesi</em> ogni giorno, <em>8 ore al giorno</em>, siamo partiti
          da <em>Html</em> e <em>Css</em> poi <em>Bootstrap</em>, <em>PHP</em>,
          <em>Mysql</em> , <em>JavaScript</em>, <em>Node.js</em> con
        ...
        <p>
          ...
          <span className="ev">Angular</span> e <span className="ev">Firebase</span>,
          nel frattempo iniziai a lavorare come docente freelance e creai il mio
          <a
            className="link"
        ...
        <p>
          ...
          saperne di più visita il mio<a
            className="link"
        ...
        <p>
          ...
          <span className="ev"> nomade digitale </span> e viaggiare in bellissimi
          posti come:
        </p>
        <p>
        ...
        <p className={style.stack}>
          HTML - CSS - SASS - JAVASCRIPT - TYPESCRIPT - ANGULAR - REACT - NEXT.JS -
          AKITA - RXJS - FIREBASE - IONIC - GIT - WEBFLOW - NOTION
        </p>
      </div>
      </div>
    </section>
